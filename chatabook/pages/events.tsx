  ...
  return (
    <>
      {userData.userData.roleId > 1 ? (
        <div className="bg-view bg-cover bg-fixed min-h-[100vh]  h-[100%] flex flex-col gap-2">
          <div className="ml-auto mr-auto"> {user && <Header />}</div>
          <CalendarComponent eventsdata={calendarEvents} />
          <div className="flex flex-col gap-2 max-md:gap-1 justify-content-center ml-auto mr-auto">
            {userData.userData.roleId > 2 && (
              <button
                className="bg-[#1e2024] hover:bg-[#d4bc98] hover:bg-opacity-80 hover:text-[#1e2024] text-[#d4bc98]  py-1 px-3 border border-[#d4bc98] hover:border-[#1e2024] rounded-xl shadow font-ysabeau font-extralight text-lg bg-opacity-90 "
                onClick={handleClick}
              >
                Vytvoriť udalost
              </button>
            ...
            <button
              className="bg-[#1e2024] hover:bg-[#d4bc98] hover:bg-opacity-80 hover:text-[#1e2024] text-[#d4bc98]  py-1 px-3 border border-[#d4bc98] hover:border-[#1e2024] rounded-xl shadow font-ysabeau font-extralight text-lg bg-opacity-90 mt-0 "
          ...
          <button
            className="bg-[#1e2024] hover:bg-[#d4bc98] hover:bg-opacity-80 hover:text-[#1e2024] text-[#d4bc98]  py-1 px-3 border border-[#d4bc98] hover:border-[#1e2024] rounded-xl shadow font-ysabeau font-extralight text-lg  ml-auto mr-auto mb-2"
            onClick={() => router.push('/')}
          >
        ...
        <div className="bg-view bg-cover bg-scroll flex flex-col justify-start items-center h-screen w-screen">
          ...
          <button
            className="bg-white hover:bg-gray-100 text-gray-800  py-1 px-3 border border-gray-400 rounded-xl shadow font-ysabeau font-extralight text-lg  max-w-md bg-opacity-90"
            onClick={() => router.push('/')}
          >
            Späť na domovskú stránku
          </button>
